...
const Home = () => {
    const apiKey = "api_key=81b88a226747068a88e372f15a6d8a27";
    ...
    useEffect(() =>{
        ...
        if (selectedGenres.length === 0) {
            fetch(
                ...
                Response.json().then((data) => setdefaultMovie(data.results))
            );
        }
    },[selectedGenres])
    useEffect(() => {
        ...
        <div className="container-fluid">
            ...
            <div className="container-fluid HomeMovies">
                <div className="container HomeMovieGrid">
                    {currMovies.length > 0 ? renderMovies() : renderDefaultMovies()}
                </div>
            </div>
        </div>
    );
